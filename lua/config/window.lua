...
vim.api.nvim_create_user_command("WindowJumpTop", function()
	jump("k")
end, {})
vim.api.nvim_create_user_command("WindowJumpBottom", function()
	jump("j")
end, {})
vim.api.nvim_create_user_command("WindowJumpLeft", function()
	jump("h")
end, {})
vim.api.nvim_create_user_command("WindowJumpRight", function()
	jump("l")
end, {})

vim.api.nvim_create_user_command("WindowResizeTop", function()
	resize("k")
end, {})
vim.api.nvim_create_user_command("WindowResizeBottom", function()
	resize("j")
end, {})
vim.api.nvim_create_user_command("WindowResizeLeft", function()
	resize("h")
end, {})
vim.api.nvim_create_user_command("WindowResizeRight", function()
	resize("l")
end, {})

vim.api.nvim_create_user_command("WindowMoveTop", function()
	move("k")
end, {})
vim.api.nvim_create_user_command("WindowMoveBottom", function()
	move("j")
end, {})
vim.api.nvim_create_user_command("WindowMoveLeft", function()
	move("h")
end, {})
vim.api.nvim_create_user_command("WindowMoveRight", function()
	move("l")
end, {})
...
local function map_set(key, cmd, term)
	...
	vim.keymap.set(
		"i",
		"<C-S-M-w>" .. key,
		string.format("<Esc>:%s<CR>:RestoreCursor force<CR>", cmd),
		{ silent = true }
	)
	...
	elseif term == 2 then
		vim.keymap.set(
			"t",
			"<C-S-M-w>" .. key,
			string.format("<C-\\><C-n>:%s<CR>:startinsert<CR>", cmd),
			{ silent = true }
		)
	end
end
